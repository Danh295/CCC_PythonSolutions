# For every plank length, if the lengths are the same, divide the number of planks
# with that length by two to get the number of possible board lengths, or if the
# lengths are different, take the minimum of the numner of different lengths, to 
# avoid over counting
...
for length in lengths:
    l[length] += 1
    #dictionary, uses the index as the key and the element as the value
    #l[1]=6
    #l[2]=1
    #l[3]=1
    #l[4]=1
